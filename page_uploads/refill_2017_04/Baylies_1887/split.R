# Cut the Baylies 1887 into individual page files.
#  rotated, sized and comnpressed for oW-Whaling

base.dir<-sprintf("%s/oW4_logbooks/refill_2017_04",Sys.getenv('SCRATCH'))

photos<-Sys.glob(sprintf("%s/originals/Baylies_1887_hard/*",
                         base.dir))

uploads.dir<-sprintf("%s/for_upload/Baylies_1887",
                     base.dir)

p1.coords<-list(x=c(0,1400),y=c(500,2550))
p2.coords<-list(x=c(1200,2612),y=c(500,2550))

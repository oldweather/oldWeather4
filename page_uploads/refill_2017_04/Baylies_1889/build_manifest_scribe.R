# Make the scribe CSV files for the Baylies 1889 images
...
log.files<-Sys.glob(sprintf("%s/oW4_logbooks/refill_2017_04/for_upload/Baylies_1889/*.jpg",
                            Sys.getenv('SCRATCH')))

# Redirect ouput to the manifest file
sink(sprintf("group_Baylies_1889.csv",part))

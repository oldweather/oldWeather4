# Cut the Monterey 1905 into individual page files.
#  rotated, sized and compressed for oW-Whaling

base.dir<-sprintf("%s/oW4_logbooks/refill_2017_04",Sys.getenv('SCRATCH'))

photos<-Sys.glob(sprintf("%s/originals/Monterey_1905/*",
                         base.dir))

uploads.dir<-sprintf("%s/for_upload/Monterey_1905",
                     base.dir)

p1.coords<-list(x=c(0,1350),y=c(500,2750))
p2.coords<-list(x=c(1150,2492),y=c(500,2750))

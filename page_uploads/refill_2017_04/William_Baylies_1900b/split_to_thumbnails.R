# Cut the William Baylies 1900b into individual page files.
...
uploads.dir<-sprintf("%s/thumbnails/William_Baylies_1900b",
                     base.dir             )
...
# Images 39-75 in this batch (image 0 is a calibration pic)
for(i in seq(39,75)) {
  pic<-photos[i+1]
  up.dir<-uploads.dir

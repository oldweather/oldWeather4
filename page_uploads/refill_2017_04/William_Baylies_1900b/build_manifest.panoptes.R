# Make the manifest CSV files for the William Baylies 1900b images

base.dir<-sprintf("%s/oW4_logbooks/refill_2017_04",Sys.getenv('SCRATCH'))

log.files<-Sys.glob(sprintf("%s/for_upload/William_Baylies_1900b/*.jpg",base.dir))

# Redirect ouput to the manifest file
sink(sprintf("%s/for_upload/William_Baylies_1900b/manifest.csv",base.dir))

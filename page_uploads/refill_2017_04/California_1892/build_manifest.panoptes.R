# Make the manifest CSV files for the California 1892 images

base.dir<-sprintf("%s/oW4_logbooks/refill_2017_04",Sys.getenv('SCRATCH'))

log.files<-Sys.glob(sprintf("%s/for_upload/California_1892/*.jpg",base.dir))

# Redirect ouput to the manifest file
sink(sprintf("%s/for_upload/California_1892/manifest.csv",base.dir))

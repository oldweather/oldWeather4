# Make the scribe CSV files for the Beluga 1893a images
...
log.files<-Sys.glob(sprintf("%s/oW4_logbooks/refill_2017_04/for_upload/Beluga_1893a/*.jpg",
                            Sys.getenv('SCRATCH')))

# Redirect ouput to the manifest file
sink(sprintf("group_Beluga_1893a.csv",part))

# Cut the Beluga 1893b into individual page files.
#  rotated, sized and comnpressed for oW-Whaling

base.dir<-sprintf("%s/oW4_logbooks/refill_2017_04",Sys.getenv('SCRATCH'))

photos<-Sys.glob(sprintf("%s/originals/Beluga_1893b/*",
                         base.dir))

uploads.dir<-sprintf("%s/for_upload/Beluga_1893b",
                     base.dir)

p1.coords<-list(x=c(150,900),y=c(750,2250))
p2.coords<-list(x=c(800,1570),y=c(750,2250))

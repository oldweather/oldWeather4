# Cut the William Baylies 1899 into individual page files.
#  rotated, sized and compressed for oW-Whaling

base.dir<-sprintf("%s/oW4_logbooks/refill_2017_04",Sys.getenv('SCRATCH'))

photos<-Sys.glob(sprintf("%s/originals/logbookofwilliam00will_1_orig_jp2/*",
                         base.dir))

uploads.dir<-sprintf("%s/thumbnails/William_Baylies_1899",
                     base.dir             )

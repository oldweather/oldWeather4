# Make the scribe CSV files for the Beluga 1893c images
...
log.files<-Sys.glob(sprintf("%s/oW4_logbooks/refill_2017_04/for_upload/Beluga_1893c/*.jpg",
                            Sys.getenv('SCRATCH')))

# Redirect ouput to the manifest file
sink(sprintf("group_Beluga_1893c.csv",part))

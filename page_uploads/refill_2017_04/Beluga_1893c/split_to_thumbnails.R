# Cut the Beluga 1893c into individual page files.
#  rotated, sized and comnpressed for oW-Whaling

base.dir<-sprintf("%s/oW4_logbooks/refill_2017_04",Sys.getenv('SCRATCH'))

photos<-Sys.glob(sprintf("%s/originals/Beluga_1893c/*",
                         base.dir))

uploads.dir<-sprintf("%s/thumbnails/Beluga_1893c",
                     base.dir)

p1.coords<-list(x=c(150,900),y=c(675,2250))
p2.coords<-list(x=c(800,1570),y=c(675,2250))

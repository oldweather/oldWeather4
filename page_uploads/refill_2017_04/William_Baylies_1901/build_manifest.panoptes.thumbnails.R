# Make the manifest CSV files for the  William Baylies 1901 thumbnails

base.dir<-sprintf("%s/oW4_logbooks/refill_2017_04",Sys.getenv('SCRATCH'))

log.files<-Sys.glob(sprintf("%s/thumbnails/William_Baylies_1901/*.jpg",base.dir))

# Redirect ouput to the manifest file
sink(sprintf("%s/thumbnails/William_Baylies_1901/manifest.csv",base.dir))

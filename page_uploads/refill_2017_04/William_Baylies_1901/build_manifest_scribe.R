# Make the scribe CSV files for the William Baylies 1901 images
...
log.files<-Sys.glob(sprintf("%s/oW4_logbooks/refill_2017_04/for_upload/William_Baylies_1901/*.jpg",
                            Sys.getenv('SCRATCH')))

# Redirect ouput to the manifest file
sink(sprintf("group_William_Baylies_1901.csv",part))

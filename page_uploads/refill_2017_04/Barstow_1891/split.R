# Cut the Barstow 1891 into individual page files.
#  rotated, sized and comnpressed for oW-Whaling

base.dir<-sprintf("%s/oW4_logbooks/refill_2017_04",Sys.getenv('SCRATCH'))

photos<-Sys.glob(sprintf("%s/originals/Barstow_1891/*",
                         base.dir))

uploads.dir<-sprintf("%s/for_upload/Barstow_1891",
                     base.dir)

p1.coords<-list(x=c(0,1300),y=c(940,2820))
p2.coords<-list(x=c(1100,3612),y=c(940,2820))

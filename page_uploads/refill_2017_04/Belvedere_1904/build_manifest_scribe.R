# Make the scribe CSV files for the Belvedere 1904 images
...
log.files<-Sys.glob(sprintf("%s/oW4_logbooks/refill_2017_04/for_upload/Belvedere_1904/*.jpg",
                            Sys.getenv('SCRATCH')))

# Redirect ouput to the manifest file
sink(sprintf("group_Belvedere_1904.csv",part))

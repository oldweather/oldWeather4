# Cut the Belvedere 1904 into individual page files.
#  rotated, sized and comnpressed for oW-Whaling

base.dir<-sprintf("%s/oW4_logbooks/refill_2017_04",Sys.getenv('SCRATCH'))

photos<-Sys.glob(sprintf("%s/originals/Belvedere_1904/*",
                         base.dir))

uploads.dir<-sprintf("%s/for_upload/Belvedere_1904",
                     base.dir)

p1.coords<-list(x=c(0,1350),y=c(700,2750))
p2.coords<-list(x=c(1150,2492),y=c(700,2750))

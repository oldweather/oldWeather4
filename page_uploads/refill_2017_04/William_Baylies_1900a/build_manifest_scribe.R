# Make the scribe CSV files for the William Baylies 1900a images
...
log.files<-Sys.glob(sprintf("%s/oW4_logbooks/refill_2017_04/for_upload/William_Baylies_1900a/*.jpg",
                            Sys.getenv('SCRATCH')))

# Redirect ouput to the manifest file
sink(sprintf("group_William_Baylies_1900a.csv",part))

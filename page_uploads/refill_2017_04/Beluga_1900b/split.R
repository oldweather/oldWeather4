# Cut the Beluga 1900b into individual page files.
...
uploads.dir<-sprintf("%s/for_upload/Beluga_1900b",
                     base.dir)
...
# 1900a is images 42-82 from this log (image 0 is a calibration pic)
for(i in seq(42,82)) {
  pic<-photos[i+1]
  up.dir<-uploads.dir

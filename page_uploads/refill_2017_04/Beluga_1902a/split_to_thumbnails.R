# Cut the Beluga 1902a into individual page files.
...
uploads.dir<-sprintf("%s/thumbnails/Beluga_1902a",
                     base.dir             )
...
# 1900a is images 1-341 from this log (image 0 is a calibration pic)
for(i in seq(1,44)) {
  pic<-photos[i+1]
  up.dir<-uploads.dir

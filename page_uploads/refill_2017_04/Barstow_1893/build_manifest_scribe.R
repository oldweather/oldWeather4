# Make the scribe CSV files for the Barstow 1893 images
...
log.files<-Sys.glob(sprintf("%s/oW4_logbooks/refill_2017_04/for_upload/Barstow_1893/*.jpg",
                            Sys.getenv('SCRATCH')))

# Redirect ouput to the manifest file
sink(sprintf("group_Barstow_1893.csv",part))

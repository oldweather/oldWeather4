# Cut the Alexander images into individual page files.
#  rotated, sized and comnpressed for oW-Whaling

photos<-Sys.glob(sprintf("%s/oW4_logbooks/Batch_3_201611/alexander/alexandersteamba00alex_orig_jp2/*",
                         Sys.getenv('SCRATCH')))

uploads.dir<-sprintf("%s/oW4_logbooks/Batch_3_201611/alexander/thumbnails_for_upload",
                     Sys.getenv('SCRATCH'))

p1.coords<-list(x=c(750,5352),y=c(831,3743))
